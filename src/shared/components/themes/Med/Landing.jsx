    ...
    return (
      <div>
        <Helmet
          title="Dynatic"
          meta={[
            {"name": "description", "content": "A modern static and dynamic website generator built with React and the last top technologies."}
          ]}
        />
        <Header />
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 col-md-offset-2">
                ...
                <p className="lead p-t-1">A modern static and dynamic website generator built with React and the last top technologies.</p>
                <p className="p-t-1">
